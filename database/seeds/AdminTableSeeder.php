...
class AdminTableSeeder extends Seeder
{
    public function run()
    {
        ...
        foreach(range(1, 10) as $index){
            DB::insert('insert into admin (email_admin, nama_admin, password_admin, jenis_kelamin, no_hp, terakhir_login) values (:email_admin, :nama_admin, :password_admin, :jenis_kelamin, :no_hp, :terakhir_login)',
            [
