...
class PenggunaTableSeeder extends Seeder
{
    public function run()
    {
        ...
        foreach(range(1, 10) as $index){
            DB::insert('insert into pengguna (email_pengguna, nama_pengguna, password_pengguna, jenis_kelamin, no_hp, foto_pengguna, created_at, updated_at) values (:email_pengguna, :nama_pengguna, :password_pengguna, :jenis_kelamin, :no_hp, :foto_pengguna, :created_at, :updated_at)',
            [
