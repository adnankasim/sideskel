                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><i class="fa fa-bank"></i>&nbsp; LEMBAGA</strong>
                                <a href="{{ url('lembaga/create') }}" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus fa-lg"></i> </a>
                            </div>
                            <div class="card-body">
                            ...
                            <span class="float-right"> 
                                ...
                                <table id="bootstrap-data-table" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $lembaga->nama }}</td>
                                        <td>
                                            <a href="{{ url('lembaga/'. $lembaga->id ) }}" class="btn btn-info btn-sm"><i class="fa fa-eye fa-lg"></i> </a>
                                            <a href="{{ url('lembaga/'. $lembaga->id .'/edit') }}" class="btn btn-success btn-sm"><i class="fa fa-edit fa-lg"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                {!! Form::open(['url' => 'lembaga/'.$lembaga->id, 'method' => 'delete', 'class' => 'd-inline']) !!}
