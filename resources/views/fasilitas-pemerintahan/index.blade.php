                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">FASILITAS PEMERINTAHAN</strong>
                                <a href="{{ url('fasilitas-pemerintahan/cetak') }}" class="btn btn-warning btn-sm float-right mx-1"><i class="fa fa-print"></i> CETAK </a>
                                <a href="{{ url('fasilitas-pemerintahan/create') }}" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus"></i> TAMBAH </a>
                            </div>
                            <div class="card-body">
                            ...
                            <span class="float-right"> 
                                ...
                                <table id="bootstrap-data-table" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('fasilitas-pemerintahan/'. $pemerintahan->id .'/edit') }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> EDIT</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                {!! Form::open(['url' => 'fasilitas-pemerintahan/'.$pemerintahan->id, 'method' => 'delete', 'class' => 'd-inline']) !!}
