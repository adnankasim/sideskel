                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('kegiatan/' . $kegiatan->id . '/edit') }}" class="btn btn-secondary btn-sm float-right mx-1"> EDIT </a>
                                <a href="{{ url('kegiatan') }}" class="btn btn-info btn-sm float-right mx-1"> KEMBALI </a>
                            </div>
                            <div class="card-body">
