                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('batas/cetak') }}" class="btn btn-warning btn-sm float-right mx-1"> <i class="fa fa-print"></i> CETAK </a>
                                <a href="{{ url('batas/create') }}" class="btn btn-primary btn-sm float-right"> <i class="fa fa-plus"></i> TAMBAH </a>
                            </div>
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $batas->uraian }}</td>
                                        <td>
                                            <a href="{{ url('batas/'. $batas->id .'/edit') }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> EDIT</a>
