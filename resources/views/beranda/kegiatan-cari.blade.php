            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h3 class="font-weight-bold text-black mb-5 mt-5 mt-xl-0">CARI KEGIATAN</h3>
                        {!! Form::open(['url' => 'beranda/kegiatan/cari', 'method' => 'get', 'class' => 'bg-white']) !!}
                            <div class="input-group mb-3">
                                {!! Form::text('nama', $nama, ['class' => 'form-control', 'placeholder' => 'Lorem Ipsum Dolor Sit Amet']) !!}
                    ...
                    <div class="col-12 text-center">
                        <h4 class="text-black mb-3 mt-5 mt-xl-0">Kegiatan dengan nama : <span class="font-weight-bold">{{ $nama }}</span>  </h4>
                    </div>
