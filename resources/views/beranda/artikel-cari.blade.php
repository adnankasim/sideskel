            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h3 class="font-weight-bold text-black mb-2 mt-5 mt-md-2 mt-xl-0">CARI ARTIKEL</h3>
                        
                        {!! Form::open(['url' => 'beranda/artikel/cari', 'method' => 'get', 'class' => 'bg-white']) !!}
                            <div class="input-group mb-3">
                                {!! Form::text('judul', $judul, ['class' => 'form-control', 'placeholder' => 'Lorem Ipsum Dolor Sit Amet']) !!}
                                <div class="input-group-append">
                                    <button class="btn btn-outline-primary" type="submit" id="button-addon2"><span class="fa fa-search fa-lg"></span></button>
                                </div>
                            </div>
                        {!! Form::close() !!}
                    </div>
                    ...
                    <div class="col-12 text-center">
                        <h4 class="text-black mb-3 mt-5 mt-xl-0">Artikel dengan judul : <span class="font-weight-bold">{{ $judul }}</span>  </h4>
                    </div>
