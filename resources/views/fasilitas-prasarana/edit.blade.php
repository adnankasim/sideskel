                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">FASILITAS PRA SARANA</strong>
                                ...
                                <div class="card-body" style="padding-top: 0">
                                    <form action="#" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Jalan Aspal">
                                        </div>
                                        <div class="form-group has-success">
                                            <label class="control-label mb-1">Keterangan</label>
                                            <input type="text" class="form-control" placeholder="2 KM">
                                        </div>
